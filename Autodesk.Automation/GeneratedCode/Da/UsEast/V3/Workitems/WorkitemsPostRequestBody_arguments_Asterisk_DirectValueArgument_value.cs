...
namespace Autodesk.Automation.Da.UsEast.V3.Workitems
{
    ...
    public partial class WorkitemsPostRequestBody_arguments_Asterisk_DirectValueArgument_value : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.Automation.Da.UsEast.V3.Workitems.WorkitemsPostRequestBody_arguments_Asterisk_DirectValueArgument_value"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.Automation.Da.UsEast.V3.Workitems.WorkitemsPostRequestBody_arguments_Asterisk_DirectValueArgument_value CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.Automation.Da.UsEast.V3.Workitems.WorkitemsPostRequestBody_arguments_Asterisk_DirectValueArgument_value();
        }
        /// <summary>
