...
namespace Autodesk.BIM360.Issues.V2.Containers.Item.Issues
{
    ...
    public partial class IssuesGetResponse_results_linkedDocuments_details_position : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.BIM360.Issues.V2.Containers.Item.Issues.IssuesGetResponse_results_linkedDocuments_details_position"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.BIM360.Issues.V2.Containers.Item.Issues.IssuesGetResponse_results_linkedDocuments_details_position CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.BIM360.Issues.V2.Containers.Item.Issues.IssuesGetResponse_results_linkedDocuments_details_position();
        }
        /// <summary>
