...
using Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.Item;
...
using System;
namespace Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets
{
    /// <summary>
    ...
    public partial class TimeSheetsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.Item.TimeSheetsItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.Item.TimeSheetsItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsGetResponse?> GetAsTimeSheetsGetResponseAsync(Action<RequestConfiguration<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder.TimeSheetsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsGetResponse> GetAsTimeSheetsGetResponseAsync(Action<RequestConfiguration<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder.TimeSheetsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsGetResponse>(requestInfo, global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsGetResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Retrieves one or more timesheets in the given project.
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        [Obsolete("This method is obsolete. Use GetAsTimeSheetsGetResponseAsync instead.")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsResponse?> GetAsync(Action<RequestConfiguration<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder.TimeSheetsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsResponse> GetAsync(Action<RequestConfiguration<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder.TimeSheetsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsResponse>(requestInfo, global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsPostResponse?> PostAsTimeSheetsPostResponseAsync(global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsPostResponse> PostAsTimeSheetsPostResponseAsync(global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsPostResponse>(requestInfo, global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsPostResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Creates a timesheet for the specified tracking item instance in the given project.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder.TimeSheetsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder.TimeSheetsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves one or more timesheets in the given project.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class TimeSheetsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Autodesk.BIM360.Cost.V1.Containers.Item.TimeSheets.TimeSheetsRequestBuilder.TimeSheetsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
