...
namespace Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItems
{
    ...
    public partial class PerformanceTrackingItemsGetResponse_results : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string Code { get; set; }
#endif
        /// <summary>The ID of the cost container for the project to which this tracking item belongs.</summary>
        public Guid? ContainerId { get; set; }
        /// <summary>The description of the tracking item&apos;s underlying budget.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> Locations { get; set; }
#endif
        /// <summary>The name of the tracking item&apos;s underlying budget.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>The planned start date of the performance tracking item&apos;s underlying budget.</summary>
        public DateTimeOffset? PlannedStartDate { get; set; }
        /// <summary>The quantity of the performance tracking item&apos;s underlying budget.</summary>
        public double? Quantity { get; set; }
        /// <summary>The unit of the performance tracking item&apos;s underlying budget.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItems.PerformanceTrackingItemsGetResponse_results"/> and sets the default values.
        /// </summary>
        public PerformanceTrackingItemsGetResponse_results()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItems.PerformanceTrackingItemsGetResponse_results"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItems.PerformanceTrackingItemsGetResponse_results CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItems.PerformanceTrackingItemsGetResponse_results();
        }
        /// <summary>
