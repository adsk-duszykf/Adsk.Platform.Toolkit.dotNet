...
#nullable restore
        ...
        public global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products_key? Key { get; set; }
        /// <summary>The language for the project. Only valid for the ``field`` product.Possible values: ``en``, ``de``, ``nl``, ``zh``, ``de-CH``</summary>
        public global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products_language? Language { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "key", n => { Key = n.GetEnumValue<global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products_key>(); } },
                { "language", n => { Language = n.GetEnumValue<global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products_language>(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products_status>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Autodesk.BIM360.Construction.Admin.V1.Projects.Item.WithProjectGetResponse_products_key>("key", Key);
