...
namespace Autodesk.BIM360.Bim360.Assets.V1.ErrorCodes
{
    ...
    public partial class ErrorCodesGetResponse_pagination : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.BIM360.Bim360.Assets.V1.ErrorCodes.ErrorCodesGetResponse_pagination"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.BIM360.Bim360.Assets.V1.ErrorCodes.ErrorCodesGetResponse_pagination CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.BIM360.Bim360.Assets.V1.ErrorCodes.ErrorCodesGetResponse_pagination();
        }
        /// <summary>
