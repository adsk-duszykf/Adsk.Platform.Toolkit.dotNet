...
using Autodesk.BIM360.Cost.V1.Containers.Item.CostItems.Item.SubCostItems;
using Autodesk.BIM360.Cost.V1.Containers.Item.CostItems.Item.SubCostItemsCopy;
using Autodesk.BIM360.Cost.V1.Containers.Item.CostItems.Item.SubCostItems.Item;
using Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items;
...
using Autodesk.BIM360.Cost.V1.Containers.Item.Payments.Item;
...
using CostCont = Autodesk.BIM360.Cost.V1.Containers.Item;
using Autodesk.BIM360.Cost.V1.Containers.Item.Budgets.Item;
using Autodesk.BIM360.Cost.V1.Containers.Item.ChangeOrders.Item;
using Autodesk.BIM360.Cost.V1.Containers.Item.ChangeOrders.Item.Item;
using Autodesk.BIM360.Cost.V1.Containers.Item.Contracts.Item;
using Autodesk.BIM360.Cost.V1.Containers.Item.CostItems.Item;
...
using static Autodesk.BIM360.Cost.V1.Containers.Item.Budgets.BudgetsRequestBuilder;
using static Autodesk.BIM360.Cost.V1.Containers.Item.Contracts.ContractsRequestBuilder;
using static Autodesk.BIM360.Cost.V1.Containers.Item.CostItems.CostItemsRequestBuilder;
using static Autodesk.BIM360.Cost.V1.Containers.Item.Expenses.ExpensesRequestBuilder;
using static Autodesk.BIM360.Cost.V1.Containers.Item.Attachments.AttachmentsRequestBuilder;
using static Autodesk.BIM360.Cost.V1.Containers.Item.CostItems.Item.SubCostItems.SubCostItemsRequestBuilder;
using static Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.ItemsRequestBuilder;
using static Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItemInstances.PerformanceTrackingItemInstancesRequestBuilder;
...
public class CostManager
{
    ...
    public CostManager(BaseBIM360client api)
    {
        _api = api;
    }
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-budgets-GET
    /// </remarks>
    ...
    /// <example>
    /// <code>
    /// await foreach (BudgetsGetResponse_results budget in client.CostManager.ListBudgetsAsync(projectId))
    /// {
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-budgets-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-budgets-budgetId-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-budgets-budgetId-PATCH
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="budgetId">The budget ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-budgets-budgetId-DELETE
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="budgetId">The budget ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-budgetsimport-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-budgets-contractslink-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-change-orders-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-change-orders-changeOrder-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// <example>
    /// <code>
    /// await foreach (WithChangeOrderGetResponse_results order in client.CostManager.ListChangeOrdersByTypeAsync(projectId, "pco"))
    /// {
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-change-orders-changeOrder-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-change-orders-changeOrder-id-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="changeOrderType">The change order type</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-change-orders-changeOrder-id-PATCH
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="changeOrderType">The change order type</param>
    /// <param name="changeOrderId">The change order ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-change-orders-changeOrder-id-DELETE
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="changeOrderType">The change order type</param>
    /// <param name="changeOrderId">The change order ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-contracts-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// <example>
    /// <code>
    /// await foreach (ContractsGetResponse_results contract in client.CostManager.ListContractsAsync(projectId))
    /// {
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-contracts-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-contracts-contractId-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-contracts-contractId-PATCH
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="contractId">The contract ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-contracts-contractId-DELETE
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="contractId">The contract ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-cost-items-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// <example>
    /// <code>
    /// await foreach (CostItemsGetResponse_results item in client.CostManager.ListCostItemsAsync(projectId))
    /// {
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-cost-items-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-cost-itemsbatch-create-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-cost-itemsattach-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-cost-itemsdetach-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-cost-items-costItemId-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-cost-items-costItemId-PATCH
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="costItemId">The cost item ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-cost-items-costItemId-DELETE
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="costItemId">The cost item ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    ...
    #region Sub Cost Item Operations

    /// <summary>
    /// Lists sub cost items for a cost item with automatic pagination.
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/cost-items/{costItemId}/sub-cost-items
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-sub-cost-items-GET
    /// </remarks>
    public async IAsyncEnumerable<SubCostItemsGetResponse_results> ListSubCostItemsAsync(
        Guid containerId,
        string costItemId,
        RequestConfiguration<SubCostItemsRequestBuilderGetQueryParameters>? requestConfiguration = null,
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        int offset = requestConfiguration?.QueryParameters?.Offset ?? 0;
        while (true)
        {
            SubCostItemsGetResponse? response = await _api.Cost.V1.Containers[containerId].CostItems[costItemId].SubCostItems
                .GetAsync(r =>
                {
                    r.Headers = requestConfiguration?.Headers ?? r.Headers;
                    r.QueryParameters = requestConfiguration?.QueryParameters ?? r.QueryParameters;
            ...
            foreach (SubCostItemsGetResponse_results row in response.Results)
                yield return row;
    ...
    /// <summary>
    /// Gets a single page of sub cost items for a cost item.
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/cost-items/{costItemId}/sub-cost-items
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-sub-cost-items-GET
    /// </remarks>
    public async Task<SubCostItemsGetResponse?> GetSubCostItemsAsync(
        Guid containerId,
        string costItemId,
        RequestConfiguration<SubCostItemsRequestBuilderGetQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].CostItems[costItemId].SubCostItems.GetAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.QueryParameters = requestConfiguration?.QueryParameters ?? r.QueryParameters;
                r.Options = requestConfiguration?.Options ?? r.Options;
    ...
    /// <summary>
    /// Creates a sub cost item under a cost item.
    /// </summary>
    /// <remarks>
    /// Wraps: POST /cost/v1/containers/{containerId}/cost-items/{costItemId}/sub-cost-items
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-sub-cost-items-POST
    /// </remarks>
    public async Task<SubCostItemsPostResponse?> CreateSubCostItemAsync(
        Guid containerId,
        string costItemId,
        SubCostItemsPostRequestBody body,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].CostItems[costItemId].SubCostItems.PostAsync(body, r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Updates a sub cost item.
    /// </summary>
    /// <remarks>
    /// Wraps: PATCH /cost/v1/containers/{containerId}/cost-items/{costItemId}/sub-cost-items/{subCostItemId}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-sub-cost-items-subCostItemsId-PATCH
    /// </remarks>
    public async Task<WithSubCostItemsPatchResponse?> UpdateSubCostItemAsync(
        Guid containerId,
        string costItemId,
        Guid subCostItemId,
        WithSubCostItemsPatchRequestBody body,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].CostItems[costItemId].SubCostItems[subCostItemId].PatchAsync(body, r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Deletes a sub cost item.
    /// </summary>
    /// <remarks>
    /// Wraps: DELETE /cost/v1/containers/{containerId}/cost-items/{costItemId}/sub-cost-items/{subCostItemId}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-sub-cost-items-subCostItemsId-DELETE
    /// </remarks>
    public async Task DeleteSubCostItemAsync(
        Guid containerId,
        string costItemId,
        Guid subCostItemId,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        await _api.Cost.V1.Containers[containerId].CostItems[costItemId].SubCostItems[subCostItemId].DeleteAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Copies sub cost items from one type to another within a cost item.
    /// </summary>
    /// <remarks>
    /// Wraps: POST /cost/v1/containers/{containerId}/cost-items/{costItemId}/sub-cost-items:copy
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-sub-cost-itemscopy-POST
    /// </remarks>
    public async Task<SubCostItemsCopyPostResponse?> CopySubCostItemsAsync(
        Guid containerId,
        string costItemId,
        SubCostItemsCopyPostRequestBody body,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].CostItems[costItemId].SubCostItemsCopy.PostAsync(body, r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// <example>
    /// <code>
    /// await foreach (ExpensesGetResponse_results expense in client.CostManager.ListExpensesAsync(projectId))
    /// {
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-id-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-id-PATCH
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="expenseId">The expense ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-id-DELETE
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="expenseId">The expense ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-expenseId-items-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="expenseId">The expense ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-expenseId-items-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="expenseId">The expense ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-expenseId-items-id-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="expenseId">The expense ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-expenseId-items-id-PATCH
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="expenseId">The expense ID</param>
    /// <param name="itemId">The expense line item ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-expenses-expenseId-items-id-DELETE
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="expenseId">The expense ID</param>
    /// <param name="itemId">The expense line item ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-id-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// <summary>
    /// Updates a main contract.
    /// </summary>
    /// <remarks>
    /// Wraps: PATCH /cost/v1/containers/{containerId}/main-contracts/{id}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-id-PATCH
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="mainContractId">The main contract ID</param>
    /// <param name="body">The main contract update payload</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    /// <returns>A <see cref="CostCont.MainContracts.Item.PatchResponse"/> containing the updated main contract</returns>
    /// <example>
    /// <code>
    /// CostCont.MainContracts.Item.PatchResponse? updated = await client.CostManager.UpdateMainContractAsync(projectId, mainContractId, new CostCont.MainContracts.Item.PatchRequestBody());
    /// </code>
    /// </example>
    public async Task<CostCont.MainContracts.Item.PatchResponse?> UpdateMainContractAsync(
        Guid containerId,
        Guid mainContractId,
        CostCont.MainContracts.Item.PatchRequestBody body,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].MainContracts[mainContractId].PatchAsync(body, r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Deletes a main contract.
    /// </summary>
    /// <remarks>
    /// Wraps: DELETE /cost/v1/containers/{containerId}/main-contracts/{id}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-id-DELETE
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="mainContractId">The main contract ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    ...
    /// <example>
    /// <code>
    /// await client.CostManager.DeleteMainContractAsync(projectId, mainContractId);
    /// </code>
    /// </example>
    public async Task DeleteMainContractAsync(
        Guid containerId,
        Guid mainContractId,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        await _api.Cost.V1.Containers[containerId].MainContracts[mainContractId].DeleteAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Lists main contract line items with automatic pagination.
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/main-contracts/{mainContractId}/items
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-mainContractId-items-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="mainContractId">The main contract ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    /// <returns>An <see cref="IAsyncEnumerable{T}"/> of <see cref="ItemsGetResponse_results"/> items, automatically paginated</returns>
    /// <example>
    /// <code>
    /// await foreach (ItemsGetResponse_results row in client.CostManager.ListMainContractItemsAsync(projectId, mainContractId))
    /// {
    ///     Console.WriteLine(row.Id);
    /// }
    /// </code>
    /// </example>
    public async IAsyncEnumerable<Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.ItemsGetResponse_results> ListMainContractItemsAsync(
        Guid containerId,
        Guid mainContractId,
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        while (true)
        {
            global::Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.ItemsGetResponse? response = await _api.Cost.V1.Containers[containerId].MainContracts[mainContractId].Items
                .GetAsync(r =>
                {
                    r.Headers = requestConfiguration?.Headers ?? r.Headers;
                    r.QueryParameters = requestConfiguration?.QueryParameters ?? r.QueryParameters;
            ...
            foreach (global::Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.ItemsGetResponse_results item in response.Results)
                yield return item;
    ...
    /// <summary>
    /// Gets a single page of main contract line items.
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/main-contracts/{mainContractId}/items
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-mainContractId-items-GET
    /// </remarks>
    public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.ItemsGetResponse?> GetMainContractItemsAsync(
        Guid containerId,
        Guid mainContractId,
        RequestConfiguration<ItemsRequestBuilderGetQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].MainContracts[mainContractId].Items.GetAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.QueryParameters = requestConfiguration?.QueryParameters ?? r.QueryParameters;
                r.Options = requestConfiguration?.Options ?? r.Options;
    ...
    /// <summary>
    /// Creates a main contract line item.
    /// </summary>
    /// <remarks>
    /// Wraps: POST /cost/v1/containers/{containerId}/main-contracts/{mainContractId}/items
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-mainContractId-items-POST
    /// </remarks>
    public async Task<CostCont.MainContracts.Item.Items.ItemsPostResponse?> CreateMainContractItemAsync(
        Guid containerId,
        Guid mainContractId,
        CostCont.MainContracts.Item.Items.ItemsPostRequestBody body,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].MainContracts[mainContractId].Items.PostAsync(body, r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Gets a main contract line item by ID.
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/main-contracts/{mainContractId}/items/{itemId}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-mainContractId-items-id-GET
    /// </remarks>
    public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.Item.ItemsGetResponse?> GetMainContractItemAsync(
        Guid containerId,
        Guid mainContractId,
        Guid itemId,
        RequestConfiguration<global::Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.Item.ItemsItemRequestBuilder.ItemsItemRequestBuilderGetQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].MainContracts[mainContractId].Items[itemId].GetAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.QueryParameters = requestConfiguration?.QueryParameters ?? r.QueryParameters;
                r.Options = requestConfiguration?.Options ?? r.Options;
    ...
    /// <summary>
    /// Updates a main contract line item.
    /// </summary>
    /// <remarks>
    /// Wraps: PATCH /cost/v1/containers/{containerId}/main-contracts/{mainContractId}/items/{itemId}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-mainContractId-items-id-PATCH
    /// </remarks>
    public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.Item.ItemsPatchResponse?> UpdateMainContractItemAsync(
        Guid containerId,
        Guid mainContractId,
        Guid itemId,
        global::Autodesk.BIM360.Cost.V1.Containers.Item.MainContracts.Item.Items.Item.ItemsPatchRequestBody body,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].MainContracts[mainContractId].Items[itemId].PatchAsync(body, r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Deletes a main contract line item.
    /// </summary>
    /// <remarks>
    /// Wraps: DELETE /cost/v1/containers/{containerId}/main-contracts/{mainContractId}/items/{itemId}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-main-contracts-mainContractId-items-id-DELETE
    /// </remarks>
    public async Task DeleteMainContractItemAsync(
        Guid containerId,
        Guid mainContractId,
        Guid itemId,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        await _api.Cost.V1.Containers[containerId].MainContracts[mainContractId].Items[itemId].DeleteAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-payment-items-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-payments-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    /// <returns>A <see cref="Autodesk.BIM360.Cost.V1.Containers.Item.Payments.PaymentsGetResponse"/> containing the payments</returns>
    /// <example>
    /// <code>
    /// Autodesk.BIM360.Cost.V1.Containers.Item.Payments.PaymentsGetResponse? payments = await client.CostManager.GetPaymentsAsync(projectId);
    /// </code>
    /// </example>
    public async Task<Autodesk.BIM360.Cost.V1.Containers.Item.Payments.PaymentsGetResponse?> GetPaymentsAsync(
        Guid containerId,
    ...
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/payments/{id}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-payments-id-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="paymentId">The payment ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    /// <returns>A <see cref="Autodesk.BIM360.Cost.V1.Containers.Item.Payments.Item.PaymentsGetResponse"/> containing the payment</returns>
    /// <example>
    /// <code>
    /// Autodesk.BIM360.Cost.V1.Containers.Item.Payments.Item.PaymentsGetResponse? payment = await client.CostManager.GetPaymentAsync(projectId, paymentId);
    /// </code>
    /// </example>
    public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.Payments.Item.PaymentsGetResponse?> GetPaymentAsync(
        Guid containerId,
        string paymentId,
        RequestConfiguration<PaymentsItemRequestBuilder.PaymentsItemRequestBuilderGetQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].Payments[paymentId].GetAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.QueryParameters = requestConfiguration?.QueryParameters ?? r.QueryParameters;
                r.Options = requestConfiguration?.Options ?? r.Options;
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-attachments-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// <example>
    /// <code>
    /// await foreach (AttachmentsGetResponse_results attachment in client.CostManager.ListAttachmentsAsync(projectId))
    /// {
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-attachmentsbatch-create-POST
    /// </remarks>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-attachments-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-attachments-attachmentId-DELETE
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-attachment-folders-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-properties-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    public async Task<PropertiesGetResponse?> GetPropertiesAsync(
        Guid containerId,
        RequestConfiguration<Autodesk.BIM360.Cost.V1.Containers.Item.Properties.PropertiesRequestBuilder.PropertiesRequestBuilderGetQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-property-valuesbatch-update-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-segment-values-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-values-GET
    /// </remarks>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-valuesimport-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-values-valueId-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="segmentId">The segment ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-templates-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-templates-templateId-segments-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-taxes-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-documents-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-schedule-of-values-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-time-sheets-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-time-sheets-id-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-items-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-items-POST
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-items-id-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
    /// <param name="itemId">The performance tracking item ID</param>
    /// <param name="requestConfiguration">(Optional) Configuration for the request</param>
    /// <param name="cancellationToken">(Optional) Cancellation token</param>
    /// <returns>A <see cref="Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItems.Item.PerformanceTrackingItemsGetResponse"/> containing the performance tracking item</returns>
    /// <example>
    /// <code>
    /// Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItems.Item.PerformanceTrackingItemsGetResponse? item = await client.CostManager.GetPerformanceTrackingItemAsync(projectId, itemId);
    /// </code>
    /// </example>
    public async Task<Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItems.Item.PerformanceTrackingItemsGetResponse?> GetPerformanceTrackingItemAsync(
        Guid containerId,
        Guid itemId,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    ...
    /// <summary>
    /// Lists performance tracking item instances with automatic pagination.
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/performance-tracking-item-instances
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-item-instances-GET
    /// </remarks>
    public async IAsyncEnumerable<PerformanceTrackingItemInstancesGetResponse_results> ListPerformanceTrackingItemInstancesAsync(
        Guid containerId,
        RequestConfiguration<PerformanceTrackingItemInstancesRequestBuilderGetQueryParameters>? requestConfiguration = null,
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        int offset = requestConfiguration?.QueryParameters?.Offset ?? 0;
        while (true)
        {
            Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItemInstances.PerformanceTrackingItemInstancesGetResponse? response = await _api.Cost.V1.Containers[containerId].PerformanceTrackingItemInstances
                .GetAsync(r =>
                {
                    r.Headers = requestConfiguration?.Headers ?? r.Headers;
                    r.QueryParameters = requestConfiguration?.QueryParameters ?? r.QueryParameters;
            ...
            foreach (PerformanceTrackingItemInstancesGetResponse_results row in response.Results)
                yield return row;
    ...
    /// <summary>
    /// Gets a single page of performance tracking item instances.
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/performance-tracking-item-instances
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-item-instances-GET
    /// </remarks>
    public async Task<global::Autodesk.BIM360.Cost.V1.Containers.Item.PerformanceTrackingItemInstances.PerformanceTrackingItemInstancesGetResponse?> GetPerformanceTrackingItemInstancesAsync(
        Guid containerId,
        RequestConfiguration<PerformanceTrackingItemInstancesRequestBuilderGetQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].PerformanceTrackingItemInstances.GetAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.QueryParameters = requestConfiguration?.QueryParameters ?? r.QueryParameters;
                r.Options = requestConfiguration?.Options ?? r.Options;
    ...
    /// <summary>
    /// Creates a performance tracking item instance.
    /// </summary>
    /// <remarks>
    /// Wraps: POST /cost/v1/containers/{containerId}/performance-tracking-item-instances
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-item-instances-POST
    /// </remarks>
    public async Task<PerformanceTrackingItemInstancesPostResponse?> CreatePerformanceTrackingItemInstanceAsync(
        Guid containerId,
        PerformanceTrackingItemInstancesPostRequestBody body,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].PerformanceTrackingItemInstances.PostAsync(body, r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Gets a performance tracking item instance by ID.
    /// </summary>
    /// <remarks>
    /// Wraps: GET /cost/v1/containers/{containerId}/performance-tracking-item-instances/{id}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-item-instances-id-GET
    /// </remarks>
    public async Task<CostCont.PerformanceTrackingItemInstances.Item.PerformanceTrackingItemInstancesGetResponse?> GetPerformanceTrackingItemInstanceAsync(
        Guid containerId,
        string instanceId,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].PerformanceTrackingItemInstances[instanceId].GetAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Updates a performance tracking item instance.
    /// </summary>
    /// <remarks>
    /// Wraps: PATCH /cost/v1/containers/{containerId}/performance-tracking-item-instances/{id}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-item-instances-id-PATCH
    /// </remarks>
    public async Task<CostCont.PerformanceTrackingItemInstances.Item.PerformanceTrackingItemInstancesPatchResponse?> UpdatePerformanceTrackingItemInstanceAsync(
        Guid containerId,
        string instanceId,
        CostCont.PerformanceTrackingItemInstances.Item.PerformanceTrackingItemInstancesPatchRequestBody body,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        return await _api.Cost.V1.Containers[containerId].PerformanceTrackingItemInstances[instanceId].PatchAsync(body, r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// <summary>
    /// Deletes a performance tracking item instance.
    /// </summary>
    /// <remarks>
    /// Wraps: DELETE /cost/v1/containers/{containerId}/performance-tracking-item-instances/{id}
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-performance-tracking-item-instances-id-DELETE
    /// </remarks>
    public async Task DeletePerformanceTrackingItemInstanceAsync(
        Guid containerId,
        string instanceId,
        RequestConfiguration<DefaultQueryParameters>? requestConfiguration = null,
        CancellationToken cancellationToken = default)
    {
        await _api.Cost.V1.Containers[containerId].PerformanceTrackingItemInstances[instanceId].DeleteAsync(r =>
            {
                r.Headers = requestConfiguration?.Headers ?? r.Headers;
                r.Options = requestConfiguration?.Options ?? r.Options;
            }, cancellationToken);
    ...
    /// APS docs: https://aps.autodesk.com/en/docs/bim360/v1/reference/http/cost-actions-GET
    /// </remarks>
    /// <param name="containerId">The project/container ID</param>
