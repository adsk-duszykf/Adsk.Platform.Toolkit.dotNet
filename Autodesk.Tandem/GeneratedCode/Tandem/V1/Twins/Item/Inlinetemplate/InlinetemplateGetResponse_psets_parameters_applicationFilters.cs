...
namespace Autodesk.Tandem.Tandem.V1.Twins.Item.Inlinetemplate
{
    ...
    public partial class InlinetemplateGetResponse_psets_parameters_applicationFilters : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.Tandem.Tandem.V1.Twins.Item.Inlinetemplate.InlinetemplateGetResponse_psets_parameters_applicationFilters"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.Tandem.Tandem.V1.Twins.Item.Inlinetemplate.InlinetemplateGetResponse_psets_parameters_applicationFilters CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.Tandem.Tandem.V1.Twins.Item.Inlinetemplate.InlinetemplateGetResponse_psets_parameters_applicationFilters();
        }
        /// <summary>
