...
namespace Autodesk.Tandem.Tandem.V1.ModelsRequests.Item.StreamConfigs
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public static global::Autodesk.Tandem.Tandem.V1.ModelsRequests.Item.StreamConfigs.StreamConfigsPatchResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.Tandem.Tandem.V1.ModelsRequests.Item.StreamConfigs.StreamConfigsPatchResponse();
        }
        /// <summary>
