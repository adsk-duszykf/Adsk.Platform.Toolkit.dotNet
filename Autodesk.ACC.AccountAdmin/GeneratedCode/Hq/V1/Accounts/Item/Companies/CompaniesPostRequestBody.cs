...
#nullable restore
        ...
        public global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody_country? Country { get; set; }
...
#nullable restore
        ...
        public global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody_state_or_province? StateOrProvince { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "country", n => { Country = n.GetEnumValue<global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody_country>(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "erp_id", n => { ErpId = n.GetStringValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "phone", n => { Phone = n.GetStringValue(); } },
                { "postal_code", n => { PostalCode = n.GetStringValue(); } },
                { "state_or_province", n => { StateOrProvince = n.GetEnumValue<global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody_state_or_province>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody_country>("country", Country);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("erp_id", ErpId);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("phone", Phone);
            writer.WriteStringValue("postal_code", PostalCode);
            writer.WriteEnumValue<global::Autodesk.ACC.AccountAdmin.Hq.V1.Accounts.Item.Companies.CompaniesPostRequestBody_state_or_province>("state_or_province", StateOrProvince);
