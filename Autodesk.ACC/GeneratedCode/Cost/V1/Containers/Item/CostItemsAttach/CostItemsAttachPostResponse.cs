...
namespace Autodesk.ACC.Cost.V1.Containers.Item.CostItemsAttach
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public static global::Autodesk.ACC.Cost.V1.Containers.Item.CostItemsAttach.CostItemsAttachPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.Cost.V1.Containers.Item.CostItemsAttach.CostItemsAttachPostResponse();
        }
        /// <summary>
