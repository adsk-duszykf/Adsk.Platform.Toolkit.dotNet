...
using System;
namespace Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values
{
    /// <summary>
    ...
    public partial class ValuesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.Item.WithValueItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.Item.WithValueItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// Online documentation <see href="https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-values-GET" />
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesGetResponse"/></returns>
...
#nullable restore
        ...
        /// Online documentation <see href="https://aps.autodesk.com/en/docs/acc/v1/reference/http/cost-values-POST" />
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesPostResponse"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesRequestBuilder.ValuesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesRequestBuilder.ValuesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.ACC.Cost.V1.Containers.Item.Segments.Item.Values.ValuesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves all of the defined segment values for a specific segment.
        /// </summary>
