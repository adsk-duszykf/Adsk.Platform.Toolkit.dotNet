...
#nullable enable
        public global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse_errorInfo? ErrorInfo { get; set; }
#nullable restore
#else
        public global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse_errorInfo ErrorInfo { get; set; }
#endif
...
#nullable restore
        ...
        public static global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "associationType", n => { AssociationType = n.GetEnumValue<global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse_associationType>(); } },
                { "createdAt", n => { CreatedAt = n.GetDateTimeOffsetValue(); } },
                { "errorInfo", n => { ErrorInfo = n.GetObjectValue<global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse_errorInfo>(global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse_errorInfo.CreateFromDiscriminatorValue); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse_associationType>("associationType", AssociationType);
            writer.WriteDateTimeOffsetValue("createdAt", CreatedAt);
            writer.WriteObjectValue<global::Autodesk.ACC.Cost.V1.Containers.Item.Documents.DocumentsGetResponse_errorInfo>("errorInfo", ErrorInfo);
