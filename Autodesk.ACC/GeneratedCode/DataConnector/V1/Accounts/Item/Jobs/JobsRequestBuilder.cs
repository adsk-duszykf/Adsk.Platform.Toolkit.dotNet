...
namespace Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs
{
    ...
    {
        /// <summary>Gets an item from the Autodesk.ACC.dataConnector.v1.accounts.item.jobs.item collection</summary>
        ...
        public global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.Item.WithJobItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("jobId", position);
                return new global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.Item.WithJobItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Autodesk.ACC.dataConnector.v1.accounts.item.jobs.item collection</summary>
        /// <param name="position">The job ID</param>
        ...
        public global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.Item.WithJobItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsGetResponse?> GetAsJobsGetResponseAsync(Action<RequestConfiguration<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder.JobsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsGetResponse> GetAsJobsGetResponseAsync(Action<RequestConfiguration<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder.JobsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsGetResponse>(requestInfo, global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsGetResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// To get request IDs for your requests, use `GET requests &lt;/en/docs/bim360/v1/reference/http/data-connector-requests-GET/&gt;`_.
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        [Obsolete("This method is obsolete. Use GetAsJobsGetResponseAsync instead.")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsResponse?> GetAsync(Action<RequestConfiguration<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder.JobsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsResponse> GetAsync(Action<RequestConfiguration<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder.JobsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsResponse>(requestInfo, global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsResponse.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// To get request IDs for your requests, use `GET requests &lt;/en/docs/bim360/v1/reference/http/data-connector-requests-GET/&gt;`_.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder.JobsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder.JobsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// To get request IDs for your requests, use `GET requests &lt;/en/docs/bim360/v1/reference/http/data-connector-requests-GET/&gt;`_.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class JobsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Autodesk.ACC.DataConnector.V1.Accounts.Item.Jobs.JobsRequestBuilder.JobsRequestBuilderGetQueryParameters>
        {
        }
    }
}
