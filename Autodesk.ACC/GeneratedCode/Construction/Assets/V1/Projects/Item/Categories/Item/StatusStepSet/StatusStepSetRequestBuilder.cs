...
using System;
namespace Autodesk.ACC.Construction.Assets.V1.Projects.Item.Categories.Item.StatusStepSet
{
    /// <summary>
    /// Builds and executes requests for operations under \construction\assets\v1\projects\{projectId}\categories\{categoryId}\status-step-set
    /// </summary>
    ...
    public partial class StatusStepSetRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Autodesk.ACC.Construction.Assets.V1.Projects.Item.Categories.Item.StatusStepSet.Item.WithStatusStepSetItemRequestBuilder this[Guid position]
        {
            get
            {
        ...
        public StatusStepSetRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/assets/v1/projects/{projectId}/categories/{categoryId}/status-step-set", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Assets.V1.Projects.Item.Categories.Item.StatusStepSet.StatusStepSetRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StatusStepSetRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/assets/v1/projects/{projectId}/categories/{categoryId}/status-step-set", rawUrl)
        {
        }
    }
}
