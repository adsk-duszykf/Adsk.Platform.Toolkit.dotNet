...
using Autodesk.ACC.Construction.Locations.V2.Projects.Item;
...
using System;
namespace Autodesk.ACC.Construction.Locations.V2.Projects
{
    /// <summary>
    /// Builds and executes requests for operations under \construction\locations\v2\projects
    /// </summary>
    ...
    public partial class ProjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Autodesk.ACC.Construction.Locations.V2.Projects.Item.WithProjectItemRequestBuilder this[Guid position]
        {
            get
            {
                ...
                return new global::Autodesk.ACC.Construction.Locations.V2.Projects.Item.WithProjectItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Autodesk.ACC.construction.locations.v2.projects.item collection</summary>
        /// <param name="position">The identifier of the project that contains your locations tree.Use the Data Management API to `retrieve the relevant ACC account and project IDs &lt;/en/docs/acc/v1/tutorials/getting-started/retrieve-account-and-project-id/&gt;`_.</param>
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Locations.V2.Projects.ProjectsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/locations/v2/projects", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Locations.V2.Projects.ProjectsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/locations/v2/projects", rawUrl)
        {
        }
    }
}
