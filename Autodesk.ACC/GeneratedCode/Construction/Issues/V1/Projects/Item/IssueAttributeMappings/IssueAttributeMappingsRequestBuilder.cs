...
namespace Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeMappings
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeMappings.IssueAttributeMappingsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IssueAttributeMappingsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/issues/v1/projects/{projectId}/issue-attribute-mappings{?filter%5BattributeDefinitionId%5D*,filter%5BcreatedAt%5D*,filter%5BdeletedAt%5D*,filter%5BmappedItemId%5D*,filter%5BupdatedAt%5D*,limit*,offset*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeMappings.IssueAttributeMappingsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IssueAttributeMappingsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/issues/v1/projects/{projectId}/issue-attribute-mappings{?filter%5BattributeDefinitionId%5D*,filter%5BcreatedAt%5D*,filter%5BdeletedAt%5D*,filter%5BmappedItemId%5D*,filter%5BupdatedAt%5D*,limit*,offset*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeMappings.IssueAttributeMappingsRequestBuilder.IssueAttributeMappingsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeMappings.IssueAttributeMappingsRequestBuilder.IssueAttributeMappingsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeMappings.IssueAttributeMappingsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeMappings.IssueAttributeMappingsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeMappings.IssueAttributeMappingsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves information about the issue custom attributes (custom fields) that are assigned to issue categories and issue types.
        /// </summary>
