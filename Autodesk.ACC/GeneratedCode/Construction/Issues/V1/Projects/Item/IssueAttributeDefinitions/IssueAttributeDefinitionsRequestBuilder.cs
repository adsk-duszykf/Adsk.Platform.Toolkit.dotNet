...
namespace Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeDefinitions
{
    ...
    public partial class IssueAttributeDefinitionsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public IssueAttributeDefinitionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/issues/v1/projects/{projectId}/issue-attribute-definitions{?filter%5BcreatedAt%5D*,filter%5BdataType%5D*,filter%5BdeletedAt%5D*,filter%5BupdatedAt%5D*,limit*,offset*}", rawUrl)
        {
        }
        /// <summary>
        ...
        /// Online documentation <see href="https://aps.autodesk.com/en/docs/acc/v1/reference/http/issues-issue-attribute-definitions-GET" />
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeDefinitions.IssueAttributeDefinitionsRequestBuilder.IssueAttributeDefinitionsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeDefinitions.IssueAttributeDefinitionsRequestBuilder.IssueAttributeDefinitionsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeDefinitions.IssueAttributeDefinitionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeDefinitions.IssueAttributeDefinitionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.IssueAttributeDefinitions.IssueAttributeDefinitionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves information about issue custom attributes (custom fields) for a project, including the custom attribute title, description and type.
        /// </summary>
