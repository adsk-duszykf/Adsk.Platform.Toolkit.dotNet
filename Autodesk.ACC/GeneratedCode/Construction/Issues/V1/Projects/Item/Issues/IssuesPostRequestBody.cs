...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_customAttributes>? CustomAttributes { get; set; }
#nullable restore
#else
        public List<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_customAttributes> CustomAttributes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_gpsCoordinates? GpsCoordinates { get; set; }
#nullable restore
#else
        public global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_gpsCoordinates GpsCoordinates { get; set; }
#endif
...
#nullable restore
        ...
        public static global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "customAttributes", n => { CustomAttributes = n.GetCollectionOfObjectValues<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_customAttributes>(global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_customAttributes.CreateFromDiscriminatorValue)?.AsList(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "dueDate", n => { DueDate = n.GetStringValue(); } },
                { "gpsCoordinates", n => { GpsCoordinates = n.GetObjectValue<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_gpsCoordinates>(global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_gpsCoordinates.CreateFromDiscriminatorValue); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_customAttributes>("customAttributes", CustomAttributes);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("dueDate", DueDate);
            writer.WriteObjectValue<global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.IssuesPostRequestBody_gpsCoordinates>("gpsCoordinates", GpsCoordinates);
