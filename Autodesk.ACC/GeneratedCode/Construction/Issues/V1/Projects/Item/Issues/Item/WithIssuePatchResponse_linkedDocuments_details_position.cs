...
namespace Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.Item
{
    ...
    public partial class WithIssuePatchResponse_linkedDocuments_details_position : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.Item.WithIssuePatchResponse_linkedDocuments_details_position"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.Item.WithIssuePatchResponse_linkedDocuments_details_position CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.Construction.Issues.V1.Projects.Item.Issues.Item.WithIssuePatchResponse_linkedDocuments_details_position();
        }
        /// <summary>
