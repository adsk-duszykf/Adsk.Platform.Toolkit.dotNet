...
#nullable restore
        ...
        public string Name { get; set; }
#endif
        /// <summary>The ID of the task within the review step that the attachment is associated with. The task ID identifies the specific task in the review process where the attachment belongs.This field is only required when the submittal item is in the **Review (`rev`)** state.To retrieve the task ID, call [Get tasks](https://aps.autodesk.com/en/docs/acc/v1/reference/http/submittals-tasks-GET/).</summary>
