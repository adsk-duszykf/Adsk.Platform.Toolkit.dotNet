...
using Autodesk.ACC.Construction.Submittals.V2.Projects.Item;
...
using System;
namespace Autodesk.ACC.Construction.Submittals.V2.Projects
{
    /// <summary>
    /// Builds and executes requests for operations under \construction\submittals\v2\projects
    /// </summary>
    ...
    public partial class ProjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Autodesk.ACC.Construction.Submittals.V2.Projects.Item.WithProjectItemRequestBuilder this[Guid position]
        {
            get
            {
                ...
                return new global::Autodesk.ACC.Construction.Submittals.V2.Projects.Item.WithProjectItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Autodesk.ACC.construction.submittals.v2.projects.item collection</summary>
        /// <param name="position">The ID of the project.Use the `Data Management API &lt;/en/docs/data/v2/&gt;`_ to retrieve the project ID. For more information, see the `Retrieve a Project ID &lt;https://forge.autodesk.com/en/docs/acc/v1/tutorials/getting-started/retrieve-account-and-project-id/&gt;`_ tutorial. You need to convert the project ID into a project ID for the ACC API by removing the ``**b.**`` prefix. For example, a project ID of **b.**a4be0c34a-4ab7 translates to a project ID of a4be0c34a-4ab7.</param>
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Submittals.V2.Projects.ProjectsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/submittals/v2/projects", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Submittals.V2.Projects.ProjectsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/submittals/v2/projects", rawUrl)
        {
        }
    }
}
