...
using Autodesk.ACC.Construction.Sheets.V1.Projects.Item;
...
using System;
namespace Autodesk.ACC.Construction.Sheets.V1.Projects
{
    /// <summary>
    /// Builds and executes requests for operations under \construction\sheets\v1\projects
    /// </summary>
    ...
    public partial class ProjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Autodesk.ACC.Construction.Sheets.V1.Projects.Item.WithProjectItemRequestBuilder this[Guid position]
        {
            get
            {
                ...
                return new global::Autodesk.ACC.Construction.Sheets.V1.Projects.Item.WithProjectItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Autodesk.ACC.construction.sheets.v1.projects.item collection</summary>
        /// <param name="position">The ID of the project. Use the `Data Management API &lt;/en/docs/data/v2/developers_guide/overview/&gt;`_ to retrieve the project ID. For more information, see the `Retrieve a Project ID tutorial &lt;/en/docs/acc/v1/tutorials/getting-started/retrieve-account-and-project-id/&gt;`_. You can use a project ID either with a “b.” prefix or without a “b.” prefix. For instance, a project ID of ``b.a4be0c34a-4ab7`` can also be referred to as ``a4be0c34a-4ab7``.</param>
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Sheets.V1.Projects.ProjectsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/sheets/v1/projects", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Sheets.V1.Projects.ProjectsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/sheets/v1/projects", rawUrl)
        {
        }
    }
}
