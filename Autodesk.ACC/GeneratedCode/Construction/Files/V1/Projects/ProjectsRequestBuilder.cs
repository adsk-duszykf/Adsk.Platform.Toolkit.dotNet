...
using Autodesk.ACC.Construction.Files.V1.Projects.Item;
...
using System;
namespace Autodesk.ACC.Construction.Files.V1.Projects
{
    /// <summary>
    /// Builds and executes requests for operations under \construction\files\v1\projects
    /// </summary>
    ...
    public partial class ProjectsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Autodesk.ACC.Construction.Files.V1.Projects.Item.WithProjectItemRequestBuilder this[Guid position]
        {
            get
            {
        ...
        public ProjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/files/v1/projects", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Construction.Files.V1.Projects.ProjectsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/files/v1/projects", rawUrl)
        {
        }
    }
}
