...
public class ACCclient
{
    ...
    /// <summary>
    /// Shortcut to endpoints https://developer.api.autodesk.com/construction/assets/*
    /// </summary>
    public Construction.Assets.AssetsRequestBuilder Assets => Api.Construction.Assets;
