...
{
    /// <summary>
    /// Builds and executes requests for operations under \construction\buildingconnected\v2\certificate-agencies
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CertificateAgenciesRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.BuildingConnected.Construction.Buildingconnected.V2.CertificateAgencies.CertificateAgenciesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CertificateAgenciesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/buildingconnected/v2/certificate-agencies{?cursorState*,filter%5BupdatedAt%5D*,limit*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.BuildingConnected.Construction.Buildingconnected.V2.CertificateAgencies.CertificateAgenciesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CertificateAgenciesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/construction/buildingconnected/v2/certificate-agencies{?cursorState*,filter%5BupdatedAt%5D*,limit*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.BuildingConnected.Construction.Buildingconnected.V2.CertificateAgencies.CertificateAgenciesRequestBuilder.CertificateAgenciesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.BuildingConnected.Construction.Buildingconnected.V2.CertificateAgencies.CertificateAgenciesRequestBuilder.CertificateAgenciesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.BuildingConnected.Construction.Buildingconnected.V2.CertificateAgencies.CertificateAgenciesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.BuildingConnected.Construction.Buildingconnected.V2.CertificateAgencies.CertificateAgenciesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.BuildingConnected.Construction.Buildingconnected.V2.CertificateAgencies.CertificateAgenciesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Retrieves a list of certifying agencies that are supported by BuildingConnected. New ones can be requested using [this form](https://autodeskfeedback.az1.qualtrics.com/jfe/form/SV_0JQRzXzDhGQlMCq).
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class CertificateAgenciesRequestBuilderGetQueryParameters 
        {
